...
当前源码版本：`0.6.8` build 27，同一 IPA 兼容 iOS 12+；本轮把设置、回收站等二级页面的返回按钮统一为中文“返回”，不改变应用标识与已有数据。GitHub Actions run `31235217862` 已通过真机 SDK 构建和包内版本校验，正式 IPA 发布在 `device-share-hub-v4.3.4-2026.08.08`；包内实读 `com.zwm.album`、0.6.8/build 27、最低 iOS 12.0，SHA-256 `520AFD3AACE6A7352ABA59DA7C30E17D05F1B2980FE8E66D73C20438F953C7A9`。当前实体 iPhone 仍是 0.6.7/build 26，完成用户签名覆盖安装前不得写成已安装。
