...
## 2026-08-01 Android 确认式更新 0.6.9 候选

- Android 0.6.9/code 47；iPhone 保持 0.6.7/build 26，Windows 保持 V4.1.2。
...
- 本机 20 个测试套件共 64 项单元测试、Release 构建与 Release Lint 通过；正式发布后用仍安装 0.6.8 的 Redmi Note 8 完成公网升级全流程，再补充 CI、Release、哈希和实体证据。
