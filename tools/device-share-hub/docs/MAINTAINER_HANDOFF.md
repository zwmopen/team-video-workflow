...
## 2026-08-01 Android 真机交互修复 0.6.8 候选
...
- 本机 21 个测试套件共 65 项单元测试、Release APK、Release Lint 全部通过；新增前台/后台安装页策略用例。候选 APK 为 805026 字节，SHA-256 `C7C200F4F61327D2E4470D6DDF1E72576ECA1C719A03E61C71284303745BAFF9`。发布后补充源码提交、CI run、公开 Release 与更新索引提交号。
