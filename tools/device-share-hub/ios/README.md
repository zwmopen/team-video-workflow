...
0.2.0 将同一个安装包的最低系统降到 iOS 12：iPhone 6 使用应用自己的固定文件夹，iOS 13 及以上继续支持系统文件夹选择。0.1.1 曾通过 Sideloadly 0.60.0 安装到实体 iPhone；0.2.0 的真机结果按下方记录更新。
...
0.2.0 先由 GitHub Actions 执行递归扫描单元测试、iOS 模拟器测试和真机 SDK 编译，再分别记录 iPhone 6 / iPhone 12 的安装与业务操作结果。云端编译不等于实体手机业务测试。
