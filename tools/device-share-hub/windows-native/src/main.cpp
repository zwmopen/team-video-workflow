...
constexpr wchar_t APP_VERSION[] = L"4.3.14";
...
std::optional<GitHubRelease> FetchLatestGitHubReleaseRedirect(std::wstring& error) {
    HINTERNET session = WinHttpOpen(L"DeviceShareHub/4.3.14", WINHTTP_ACCESS_TYPE_AUTOMATIC_PROXY,
...
std::optional<GitHubRelease> FetchLatestGitHubRelease(std::wstring& error) {
    ...
    WinHttpAddRequestHeaders(request,
                              L"Accept: application/vnd.github+json\r\nUser-Agent: DeviceShareHub/4.3.14\r\n",
